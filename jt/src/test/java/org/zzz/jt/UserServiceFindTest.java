...
public class UserServiceFindTest {
	...
	public void testFindByParams() {
		...
		users =  userService.findByParams(null, "michael1@mail.ru", null, null, 0, 5);	
		assertThat("find one user by email",users.size() == 1);
		
		users =  userService.findByParams(null, null, "70001111113", null, 0, 5);	
		...
		users =  userService.findByParams("mich", null, "70001111113", null, 0, 5);	
